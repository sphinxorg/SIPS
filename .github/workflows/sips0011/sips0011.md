...
```bash
Signature (35KB) → [Part1][Part2][Part3][Part4] → Merkle Tree → Root Hash (32 bytes
```
...
* Nonce: 16 bytes
* Merkle root: 32 bytes
* Total: ~120 bytes + message size, instead of  ~7KB!